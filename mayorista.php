...
$sql = "INSERT INTO `datos factura`(FechaVenta,idEmpresa,idProducto,idEmpleado,precioUnitario,cantVendida,montoTotal) 
VALUES ('$venta', '$empresa','$producto','$empleado','$precio','$cantidad','$total')";
...
<form method="post" action="#">
	<div class="row uniform">
        ...
        <div class="6u$ 12u$(xsmall)">
			<input type="number" name="idEmpresa" id="idEmpresa" value="" placeholder="Numero de empresa" />
        </div>
        <div class="6u 12u$(xsmall)">
